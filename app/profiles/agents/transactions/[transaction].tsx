        ...
        <View>
          ...
          >
            <View style={{ backgroundColor: "#e9ecef", padding: 10 }}>
              ...
              />
              <TextRowItem fisrtText="Frais" secondText={`0 FCFA`} />
              <TextRowItem
                fisrtText="Client"
                secondText={`${
                  transactionData.type_transaction_id === 1
                    ? transactionData.expediteur.nom
                    : transactionData.beneficiaire.nom
                } ${
                  transactionData.type_transaction_id === 1
                    ? transactionData.expediteur.prenoms
                    : transactionData.beneficiaire.prenoms
                }`}
              />
              <TextRowItem
                fisrtText="Numero Client"
                secondText={`${
                  transactionData.type_transaction_id === 1
                    ? transactionData.expediteur.telephone
                    : transactionData.beneficiaire.telephone
                }`}
              />
              <TextRowItem
                fisrtText="Status"
              ...
              <TextRowItem
                ...
                secondText={transactionData.uuid.substring(0, 10) + "..."}
              />
            </View>
          </View>
        </View>
